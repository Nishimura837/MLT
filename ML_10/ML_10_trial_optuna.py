...
plt.title('Error Evaluation 10 trial optuna')
plt.savefig("/home/gakubu/デスクトップ/ML_git/MLT/ML_10/Error Evaluation 10 trial optuna.pdf", format='pdf') 
...
df_ee.to_csv("/home/gakubu/デスクトップ/ML_git/MLT/ML_10/Error Evaluation 10 trial optuna.csv",encoding='utf_8_sig', index=False)