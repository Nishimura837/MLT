...
plt.scatter(iris_std_df[:, 0], iris_std_df[:, 1],
            alpha=0.4, c=target, cmap=cmap)
...
# データの可視化
plt.scatter(X[1:50, 0], X[1:50, 1], c='r',
            marker='s', edgecolor='k', label='Setosa')
plt.scatter(X[51:100, 0], X[51:100, 1], c='g',
            marker='o', edgecolor='k', label='Versicolor')
plt.scatter(X[101:150, 0], X[101:150, 1], c='b',
            marker='x', edgecolor='k', label='Varginica')
