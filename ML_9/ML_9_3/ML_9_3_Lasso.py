...
df_ee.to_csv("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/Error Evaluation 9_3 Lasso.csv",encoding='utf_8_sig', index=False)
...
df_ee_train.to_csv("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/Error Evaluation for traindata 9_3 Lasso.csv",encoding='utf_8_sig', index=False)
...
df_forfig.to_csv("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/df_forfig_Lasso.csv"\
...
plt.title('Error Evaluation Lasso')
plt.savefig("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/Error Evaluation (+test) Lasso.pdf", format='pdf') 
# plt.show()
#-------------------------------------------------------------------------------



#-----Error Evaluation (except test) Lasso.pdfの作成-----------------------------
# # 各オフィス名に対する色を 'tab20' カラーマップから取得
...
# plt.savefig("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/Error Evaluation (except test) Lasso.pdf", format='pdf') 
# # plt.show()
#-------------------------------------------------------------------------------------

#------Error Evaluation (test) Lasso.pdfの作成----------------------------------------
