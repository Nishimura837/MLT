...
folds = 10
search_space = {'degree':np.arange(1, 5), 'alpha':np.arange(0, 20.1, 0.1)}
...
df_param.to_csv("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/param Lasso.csv", encoding='utf_8_sig', index=False)
...
plt.savefig("/home/gakubu/デスクトップ/ML_git/MLT/ML_9/ML_9_3/Error Evaluation (+test) Lasso modified.pdf", format='pdf') 
# plt.show()
#-------------------------------------------------------------------------------
