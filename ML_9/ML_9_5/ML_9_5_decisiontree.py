...
def objective(trial):
    ...
    for train_idx, val_idx in kf.split(X_train):
        ...
        dt_regressor = DecisionTreeRegressor(
            max_depth=max_depth, criterion='squared_error', random_state=42)
        # モデルの学習
        dt_regressor.fit(X_train_fold, y_train_fold)

        # バリデーションデータに対する予測
        y_val_pred = dt_regressor.predict(X_val_fold)
...
df_er.to_csv(
    "/home/gakubu/デスクトップ/MLTgit/MLT/ML_9/ML_9_5/df_er_DecisionTree.csv", index=False)
...
plt.savefig("/home/gakubu/デスクトップ/MLTgit/MLT/ML_9/ML_9_5/ML_9_5_DecisionTree.png")
plt.show()
